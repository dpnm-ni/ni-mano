...
class Sfcr(object):
    ...
    def __init__(self, id=None, arrivaltime=None, name=None, source_client=None, destination_client=None, src_ip_prefix=None, dst_ip_prefix=None, src_port_min=None, src_port_max=None, dst_port_min=None, dst_port_max=None, proto=None, bw=None, delay=None, duration=None, nf_chain=None, _configuration=None):  # noqa: E501
