...
class DefaultApi(object):
    ...
    def get_last_measurement(self, id, measurement_type, **kwargs):  # noqa: E501
        """Return the latest value of a measurement of a vnf instance or compute node  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_last_measurement(id, measurement_type, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_last_measurement_with_http_info(id, measurement_type, **kwargs)  # noqa: E501
        else:
            (data) = self.get_last_measurement_with_http_info(id, measurement_type, **kwargs)  # noqa: E501
            return data

    def get_last_measurement_with_http_info(self, id, measurement_type, **kwargs):  # noqa: E501
        """Return the latest value of a measurement of a vnf instance or compute node  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_last_measurement_with_http_info(id, measurement_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'measurement_type']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_last_measurement" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/last_measurement/{id}/{measurement_type}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
